...
def _expert_selection_gating(
    ...
    num_microbatches=None, normalize_by_num_experts_routed=True):
  ...
  tf.logging.info("aggregated_group_probs: {}   true_group_size: {}".format(
      aggregated_group_probs, true_group_size))
